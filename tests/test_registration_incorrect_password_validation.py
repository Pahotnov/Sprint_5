...
from locators import MainPageLocators, AuthPageLocators, RegistrationPageLocators, UnauthorizedUserGeneralLocators
...
def test_registration_incorrect_password_validation(driver):
    ...
    driver.find_element(*UnauthorizedUserGeneralLocators.PASSWORD_INPUT_FIELD).send_keys(Data.INCORRECT_PASSWORD)
